...
class Chessboard:
    ...
    def _move_castle_pieces(self, king_src: str, king_dst: str, rook_src: str, rook_dst: str) -> None:
        ...
        """
        king = self.squares[self.square_name_to_index(king_src)]
        rook = self.squares[self.square_name_to_index(rook_src)]

        self.squares[self.square_name_to_index(king_dst)] = king
        self.squares[self.square_name_to_index(rook_dst)] = rook
        self.squares[self.square_name_to_index(king_dst)].has_moved = True
        self.squares[self.square_name_to_index(rook_dst)].has_moved = True
        self.squares[self.square_name_to_index(king_src)] = None
        self.squares[self.square_name_to_index(rook_src)] = None
    ...
    def square_name_to_index(self, square_name: str) -> Optional[int]:
        """
